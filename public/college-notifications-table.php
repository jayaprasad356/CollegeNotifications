<section class="content-header">
    ...
    <ol class="breadcrumb">
        <a class="btn btn-block btn-default" href="add-college-notification.php"><i class="fa fa-plus-square"></i> Add New Notifications</a>
    </ol>
</section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id='products_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=college-notifications" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true"  data-side-pagination="server" data-pagination="true"  data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc"  data-export-types='["txt","excel"]' data-export-options='{

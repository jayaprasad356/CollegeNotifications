...
define('DOMAIN_URL', 'http://192.168.43.122/care/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "care";    // Change as required
